...
export declare class CanvasDisplayObject extends DisposerClass implements IDisplayObject, IDisposer {
    ...
    render(status: IStatus, targetGhostLayer?: number): void;
    protected _render(status: IStatus, _targetGhostLayer?: number): void;
    protected _ghostOnly(targetGhostLayer?: number): boolean;
    protected _drawGhost(status: IStatus, targetGhostLayer?: number): boolean;
    hovering(): boolean;
    dragging(): boolean;
...
declare abstract class Op {
    ...
    colorizeGhost(context: CanvasRenderingContext2D, forceColor: string | undefined): void;
    path(_context: CanvasRenderingContext2D): void;
    pathGhost(context: CanvasRenderingContext2D): void;
...
export declare class CanvasGraphics extends CanvasDisplayObject implements IGraphics {
    ...
    endStroke(): void;
    beginPath(): void;
    lineStyle(width?: number, color?: Color | CanvasGradient | CanvasPattern, alpha?: number, lineJoin?: "miter" | "round" | "bevel", lineCap?: "butt" | "round" | "square"): void;
...
export declare class CanvasRadialText extends CanvasText implements IRadialText {
    ...
    _render(status: IStatus, targetGhostLayer?: number): void;
    _renderCircular(status: IStatus, targetGhostLayer?: number): void;
    _measure(status: IStatus): IBounds;
...
export declare class CanvasRenderer extends ArrayDisposer implements IRenderer, IDisposer {
    ...
    _deferredGhostLayers: Array<number>;
